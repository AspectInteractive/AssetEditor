...
namespace OpenRA.Mods.Common.Traits.Render
{
	...
	public class WithSpriteBody : PausableConditionalTrait<WithSpriteBodyInfo>, INotifyDamageStateChanged, IAutoMouseBounds
	{
			...
			: base(info)
		{
			...
			DefaultAnimation = new Animation(init.World.Map.Sequences, rs.GetImage(self), baseFacing, Paused);
			...
			boundsAnimation = new Animation(init.World.Map.Sequences, rs.GetImage(self), baseFacing, Paused);
